      ...
      ***** DB2 TABLE DCLGENS
       ...
       PROCEDURE DIVISION.
           ...
           PERFORM 100-MAINLINE THRU 100-EXIT
                   UNTIL NO-MORE-DATA IN MORE-DATA-SW  OR
      ...
      *  Validate patient type and insurance coverage
       ...
       300-FIELD-EDITS.
           MOVE "Y" TO ERROR-FOUND-SW IN FLAGS-AND-SWITCHES.
