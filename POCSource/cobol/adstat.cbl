       ...
       01  WORK-VARIABLES.
           05  PROGRAM-STATUS PIC X(30) VALUE SPACES.
           05  ACCUM-A        PIC S9(5) VALUE +0.
       ...
       01  ARRAY-OF-NUMBERS.
           05  NUM            PIC S9(9) COMP OCCURS 10.
       01  RESULTS.
      ...
      ****** TODO
       ...
       300-CALC-MIN-MAX-AND-RANGE.
           MOVE  'CALCULATING MIN, MAX, BUT RANGE' TO PROGRAM-STATUS.
