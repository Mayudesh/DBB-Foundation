      ...
      *
       01  WS-FIELDS.
           05  WS-UPDATE-NUM        PIC 9(9)V99  COMP-3  VALUE 0.
           05  WS-UPDATE-NUM-RDF REDEFINES WS-UPDATE-NUM PIC X(6).
      ...
      *****************************************************************
       ...
       01  TRAN-ZERO                             PIC 999 COMP-3.
       01  TRAN-ZERO-RDF REDEFINES TRAN-ZERO     PIC XXX VALUE '000'.
      ...
      *****************************************************************
       ...
       100-VALIDATE-TRAN.
           ...
           END-EVALUATE .
           IF TRAN-KEY = '13062A'
                   MOVE SPACES TO TRAN-UPDATE-NUMX.
                       ...
                       WHEN 'ADD     '
                        IF TRAN-KEY = '13062A'
                           COMPUTE CUST-ACCT-BALANCE =
                            CUST-ACCT-BALANCE + TRAN-UPDATE-NUM
                        ELSE
