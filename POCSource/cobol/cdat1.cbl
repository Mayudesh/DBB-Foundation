      ...
      *    CURRENT DATE.
      *
      *    (C) 2007 IBM - KEVIN J. CUMMINGS RESERVED.
      *    CONVERTED FOR CICS BY JANICE WINCHELL AND DOUG STOUT
       ENVIRONMENT DIVISION.
       CONFIGURATION SECTION.
       SOURCE-COMPUTER. IBM-FLEX.
       OBJECT-COMPUTER. IBM-FLEX.
      *
       DATA DIVISION.
      ...
      *
       ...
       01  CDAT2-INTERFACE-AREA.
           05 L-INPUT-DATE.
              10 L-YYYY                        PIC 9(5) VALUE 0.
              10 L-MM                          PIC 9(2) VALUE 0.
              10 L-DD                          PIC 9(2) VALUE 0.
           05 L-DAY-DIFFERENCE                 PIC S9(9).
       ...
       01  WS-COMM-AREA.
           ...
           05  W-COM-PROGRAM-AREA.
               ...
               10  W-COM-CDAT2-RETCODE         PIC S9(4).
                   88 W-COM-CDAT2-SUCCESS         VALUE  0.
                   88 W-COM-CDAT2-FAIL            VALUE -1 .

       01 W-CALL-PROGRAM           PIC X(8) VALUE 'CDAT2'.
