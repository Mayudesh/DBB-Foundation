      ...
      * CODE THE NECESSARY DB2 INCLUDE STATEMENTS HERE4
       01  WS-KTRS-SWITCHES.
           05 ROW-KTR    PIC S9(03) COMP-3 VALUE +0.
           05 PRF        PIC S9(03) VALUE +0.
           05 DPT        PIC X(9).
           05 HOURS      PIC S9(03) VALUE +0.
      ...
      * FOR MIN, MAX AND AVG(PERF) ???
       ...
       01  NULL-GROUP.
           ...
           05 LNAME-TEST     PIC  X(12) VALUE SPACES.
      ...
      *  SQL RETURN CODES (SQLCODE) FOR YOU.
       ...
       01  ERROR-MSG.
           ...
           05 ERROR-TEXT     PIC X(121) OCCURS 8 TIMES
           INDEXED BY ERR-IDX.
      ...
      * = = = > Diagnostic Codes optional
         ...
         EXEC SQL
               ...
               SELECT DEPT, MIN(PERF), MAX(PERF), AVG(PERF),
                            MIN(P.HOURS ), MAX(HOURS), AVG(HOURS)
                      FROM EMPL E, PAY P
                      WHERE E.NBR = P.NBR
                      GROUP BY DEPT
           END-EXEC.
